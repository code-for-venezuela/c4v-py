...
@pytest.fixture
def el_pitazo_snapshot() -> str:
    """
        Returns El Pitazo snapshot used to test 
        scraper parsing
    """
    with resources.open_text("resources.tests.scraper.elpitazo", "el_pitazo_fallas_electricas_carne.html") as html:
        return html.read()

@pytest.fixture
def el_pitazo_expected_body() -> str:
    """
        Expected body for this test
    """
...
@pytest.fixture
def el_pitazo_expected_title() -> str:
    """
        Text expected as title
    """
    return "Las fallas eléctricas han disminuido la cantidad de carne que consume el venezolano"

@pytest.fixture
def el_pitazo_expected_categories() -> List[str]:
    """
        list of expected tags
    """
    return ["Crónicas", "Regiones"]

@pytest.fixture
def el_pitazo_expected_author() -> str:
    """
        Expected author string
    """
    return "Redacción El Pitazo"

@pytest.fixture
def el_pitazo_expected_tags() -> str:
    """
